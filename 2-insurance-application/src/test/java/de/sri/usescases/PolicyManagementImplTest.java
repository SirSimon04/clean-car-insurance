...
class PolicyManagementImplTest {
                ...
                @Test
                void add_basic_policy() throws CustomerNotFoundException, CustomerTooYoungException,
                ...
                void add_policy_basic_with_young_driver()
                                ...
                                Customer customer = new TestCustomerDirector(new Customer.Builder())
                                                                .createYoungDriver();
                                when(customerRepository.findById(1)).thenReturn(Optional.of(customer));
                ...
                @Test
                void add_deluxe_policy() throws CustomerNotFoundException, CustomerTooYoungException,
                                                CarTooExpensiveException {
                                Customer customer = new TestCustomerDirector(new Customer.Builder()).createMockUser();
                                when(customerRepository.findById(1)).thenReturn(Optional.of(customer));
                ...
                void add_policy_with_customer_under_18_years_old() {
                                ...
                                CustomerTooYoungException exception = assertThrows(CustomerTooYoungException.class,
                                                                () -> policyManagement.addPolicyToCustomer(1, policy));
                                assertEquals("Customer has to be 18 years old to create a policy!",
